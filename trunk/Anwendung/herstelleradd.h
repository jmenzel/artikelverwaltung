#ifndef __herstelleradd__
#define __herstelleradd__
...
/**
 * Die Klasse HerstellerAdd erbt von wxFrame und ist ein eigenständiges Fenster.
 * Sie dient zum anlegen von Herstellern
 */
class HerstellerAdd : public wxFrame
{
	...
	public:
		 ...
		 */
        HerstellerAdd(MainWindow *parent);
		
		/**
		 * @param MainWindow* parent - Zeiger auf MainWindowobjekt
		 * @param CallbackBase &caller_update - Referenz auf Callback-Funktion
		 */
        HerstellerAdd(MainWindow *parent, CallbackBase &caller_update);
    ...
    private:
		...
		/**
		 * Reagiert auf drücken des Buttons "button_save". Ruft db->addNewHersteller auf,
